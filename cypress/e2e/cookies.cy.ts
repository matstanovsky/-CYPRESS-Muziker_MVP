import { AGREE_LABEL, BUTTON_SUCCESS_CLASS_LOCATOR, CONSENT_COOKIE_NAME, CONSENT_COOKIE_VALUE, CONSENT_SELECTED_COOKIE_VALUE, DISABLED_LABEL, DISAGREE_AND_SETUP_LABEL, ENABLED_LABEL, ENABLE_SELECTED_LABEL, openCookiesSettings } from "../support/pages/cookiesPage";
...
describe('Cookies alert', () => {
  ...
  it('Setting selected cookies set cookie correctly', () => {
    ...
    cy.getCookie(CONSENT_COOKIE_NAME).should('have.property','value',CONSENT_SELECTED_COOKIE_VALUE);
  })
})